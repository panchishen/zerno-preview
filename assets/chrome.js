...
(function(){
  ...
  var ЗНАКИ = {
    ...
    client: {
      стики: { src:LOGO_VERT,   w:33,  h:41  },   // только колос (макет 744:3035)
      герой: { src:LOGO_CLIENT, w:132, h:148 },
      узкий: { src:LOGO_VERT,   w:33,  h:41  },   // на узких экранах знак с надписью не помещается
