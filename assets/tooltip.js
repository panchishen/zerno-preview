/* ===== Зерно · тултип (макет 615:1059) =====
   ...
   Сторона: всегда снизу, а если там не помещается — сверху. По горизонтали
...
(function(){
  ...
  function поставить(el){
    ...
    // Подсказка всегда снизу и по центру элемента; наверх уходит только если снизу
    // не хватает места до края экрана
    var снизу = э.bottom + ОТСТУП;
    var y = снизу + т.height <= window.innerHeight - ПОЛЕ ? снизу : э.top - т.height - ОТСТУП;
